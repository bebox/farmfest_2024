...
\score {
  <<
    \new ChordNames {  \jazzChords  \shiftDurations #-1 #0  \clef bass \transpose c' c \harmonyOne }
    \new Staff {  \shiftDurations #-1 #0  \clef bass \transpose c' c \staffOne }
    \addlyrics { \tekst }
        \addlyrics { \tekstB }
