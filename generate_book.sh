...
eval "$EXEC" $MUSESCORE_PATH/$SONG19.mscx --ly-output $LILYPOND_SRC_PATH/$SONG19.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 19 --no-left-page $POINT_AND_CLICK --comment-tempo
...
eval "$EXEC" $MUSESCORE_PATH/$SONG33.mscx --ly-output $LILYPOND_SRC_PATH/$SONG33.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 33 --left-page $POINT_AND_CLICK --comment-tempo
